  ...
  action do
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Handlebars based Template Renderer',
        ...
        application_lib_namespace:  'KTemplate',
        namespaces:                 ['KTemplate'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a Prompt Engineer, I want powerful prompt template transformations, so I can parameterize and format prompts quickly',
        copyright_date:             '2024',
        website:                    'http://appydave.com/gems/k_template'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'k_template'
